...
export const VENDOR_SURFACE = {
  ...
  google: {
    ...
    device: { grains: ['campaign', 'ad_group', 'ad', 'keyword', 'ad_group_asset', 'ad_group_audience_view', 'asset_field_type_view', 'asset_group_product_group_view', 'campaign_asset', 'campaign_search_term_view', 'customer_asset', 'detail_placement_view', 'expanded_landing_page_view', 'group_placement_view', 'income_range_view', 'landing_page_view', 'paid_organic_search_term_view', 'parental_status_view', 'product_group_view', 'shopping_performance_view', 'video', 'video_enhancement'], status: 'captured', confidence: V },
    hour: { grains: GEO_CA, status: 'captured', confidence: V, note: 'ad/keyword REJECTED by Google → campaign+ad_group is complete.' },
    conversion_action: { grains: ['campaign', 'ad_group', 'keyword', 'ad_group_asset', 'asset_field_type_view', 'asset_group_product_group_view', 'campaign_asset', 'campaign_budget', 'campaign_search_term_view', 'customer_asset', 'expanded_landing_page_view', 'income_range_view', 'landing_page_view', 'location_view', 'parental_status_view', 'shopping_performance_view'], status: 'captured', confidence: V, note: 'vendor serves conv-action at ad_group + keyword too; writer is campaign-only → SLICE (queue G-FILL#9). ⛔ THE SLICE IS UNCHANGED BY THE ENTITY AXIS: the grains after keyword are VENDOR-NAMED report resources the universe walk serves this segment from (LORAMER_UNIVERSE_ENTITY_AXIS_V1, 2026-08-03); ad_group and keyword are still genuinely MISSING and this stays a SLICE.' },
