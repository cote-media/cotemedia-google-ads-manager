...
const GUARDS = [
  ...
  'tests/guards/fire-bite-fits-the-budget.guard.mjs', // LORAMER_FIRE_BITE_FITS_THE_BUDGET_V1 — the per-fire bite IS capture-budget ÷ measured worst request cycle; the admission rule refuses a unit that would not fit; replaces the retired queue-drain identity
