...
const GUARDS = [
  ...
  'tests/guards/unknown-renders-honestly.guard.mjs', // LORAMER_UNKNOWN_RENDERS_HONESTLY_V1 — part 2: the third state must survive the trip to the screen // LORAMER_FAILURE_IS_NOT_A_FACT_V1 — a failed read must never become a negative fact // LORAMER_PROTOCOL_GATE_ENFORCER_V1 — the paste-receipt gate's own failure must fail the BUILD, because Claude Code hooks fail OPEN
