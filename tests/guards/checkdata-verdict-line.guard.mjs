...
const EXPECTED_ROSTER = [
  ...
  'scripts/check-engine-marker.mjs --guard', // LORAMER_CONNECTION_ENGINE_MARKER_V1 (2026-09-22)
  'scripts/check-impression-share-parity.mjs --guard', // LORAMER_IMPRESSION_SHARE_FAMILY_V1 (2026-09-22)
