...
DONE: Meta ✅, Shopify ✅, GA4 ✅, WooCommerce ✅. REMAINING: GOOGLE only (live-API gated on the ~08:03Z 06-29 quota reset;
...
═══════════════════════════════════════════════════════════════════
## 5. COMMERCE/ANALYTICS-vs-ADS DIFFERENCES (platform-onboarding-playbook input; GA4/Woo specifics in §3/§4)
═══════════════════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════════════════
## 6. STORAGE MODEL (settled 2026-06-28; see DECISIONS) — two-layer + RAG
═══════════════════════════════════════════════════════════════════
...
(Companion: docs/LORAMER_BREAKDOWN_REGISTRY.md = per-dimension encoding. Pending inventory: GOOGLE (live-API gated on the ~2026-06-29T08:03Z quota reset; docs readable anytime) → then the cross-platform master gap list + value-ordered build queue.)
