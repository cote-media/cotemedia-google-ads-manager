...
export const QUERY_METRICS_TOOL: any = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      baseRange: {
        type: 'string',
        description: 'Rolling-comparison mode only (ignored when `windows` is set). The primary / most-recent window, as a preset: LAST_7_DAYS, LAST_14_DAYS, LAST_30_DAYS, LAST_90_DAYS, THIS_WEEK, THIS_MONTH, or LAST_MONTH. Default LAST_7_DAYS. ⚠ THIS_WEEK and THIS_MONTH are TO-DATE - they END AT TODAY, and today is never captured, so those windows come back with an extends_past_capture contribution. Every other preset ends at YESTERDAY.',
      },
      offsetsMonths: {
        type: 'array',
        items: { type: 'number' },
...
export const QUERY_BREAKDOWN_TOOL: any = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      baseRange: {
        type: 'string',
        description: 'Single-window preset: LAST_7_DAYS, LAST_14_DAYS, LAST_30_DAYS, LAST_90_DAYS, THIS_WEEK, THIS_MONTH, LAST_MONTH. ⚠ THIS_WEEK and THIS_MONTH are TO-DATE (they end at TODAY, which is never captured - expect an extends_past_capture contribution); every other preset ends at YESTERDAY. Default LAST_30_DAYS. Ignored if startDate+endDate are given.',
      },
...
export const QUERY_ENTITIES_TOOL: any = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      baseRange: { type: 'string', description: 'Single-window preset: LAST_7_DAYS, LAST_14_DAYS, LAST_30_DAYS, LAST_90_DAYS, THIS_WEEK, THIS_MONTH, LAST_MONTH. ⚠ THIS_WEEK and THIS_MONTH are TO-DATE (they end at TODAY, which is never captured - expect an extends_past_capture contribution); every other preset ends at YESTERDAY. Default LAST_30_DAYS. For any specific calendar period use startDate/endDate instead.' },
