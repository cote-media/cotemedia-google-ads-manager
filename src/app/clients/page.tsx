                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-1.5 items-center">
                            ...
                            {wooConn ? (
                              <button onClick={(e) => { e.stopPropagation(); try { localStorage.setItem('advar-active-tab', 'woocommerce') } catch {}; goToDashboard(client) }}  /* LORAMER_WOO_FIX_V2 */ className="inline-flex items-center gap-1 text-[11px] sm:text-xs font-sans font-medium px-2.5 py-0.5 rounded-full text-white hover:opacity-90 transition-opacity" style={{ background: '#96588A' }}>
