...
- generated_at: 2026-06-26T16:38:55.905Z
- built_from HEAD: cceccee111ecbd43764ab68efcb82a7ffb9941d7  (informational — do NOT gate on this; unrelated commits change HEAD without changing the digest's sources)
- FRESHNESS GATE (authoritative, deterministic): this digest is CURRENT iff EVERY source-doc content_hash
  ...
  Source-doc content_hash at build time:
    ...
    - CONTINUE_HERE.md: 27d6fa32f0dbbdd8a118af6c03f11055e266607660dde8fa30d00d869d2fd930
    - LORAMER_DECISIONS.md: d94807cf7d5b7d3286876b5cdc346cb8ecc06adad8736f6e9c5aef1d472e0eb9
    - LORAMER_QUEUE_OF_RECORD.md: e587bd27cf85e7940a79915398f88aa00ce83a277269ee1fc5a2723a2c1fbde0
...
PRIORITY ORDER (next work):
 ...
 ▶ NEXT STEP (build): Google ad_group/ad cohort drain is now AUTOMATIC — no manual action; monitor it reaches the 36-mo floor (sync_state key 'google_adgroup_ad', daysFlagged small). THEN the next depth writer in the RACING-THE-37mo-FLOOR order: Meta campaign (writer EXISTS, just wire it — one drain-registry entry, mirror google_campaign), then Meta adset / ad (no writer — mirror the placement/campaign writers), then Google+Meta breakdown breadth (device/geo/age-gender). Placement adset×/ad× (item 2) has no clock and waits. FREEZE POSTURE: backend writer/wiring only = freeze-safe. Per Lesson 61 stop at the floor as empty-success; per Lesson 59 reconcile per-day on SPEND or surface; conversion-attribution drift = accepted caveat (do NOT gate on conversions).
