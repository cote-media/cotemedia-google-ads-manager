...
- Meta ad_set + ad DEPTH backfill — forward-only, no writer (mirror meta-campaign + forward adGroups/ads aggregation; entity_level 'ad_set'/'ad'). src: DATA_COMPLETENESS, MATRIX#3. open [LC]
