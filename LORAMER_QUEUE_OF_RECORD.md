...
- CONSOLIDATION PRE-WORK (Phase 1, do FIRST, freeze-safe): shared reconcileDay(grainSpend,anchorSpend,{abs,pct,posture}) primitive replacing the 6 copy-paste reconcile blocks (google-campaign BLOCK; google-adgroup-ad/meta-campaign/meta-adset-ad/meta-placement FLAG; shopify-dimensional HALT) + shared fetch/paging/retry primitives (de-dup RETRYABLE/fetchAllWithRetry/queryWithRetry across google-*/meta-* backfills). src: design §5/§8/§11. open [LC]
